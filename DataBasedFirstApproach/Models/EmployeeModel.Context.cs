...
namespace DataBasedFirstApproach.Models
{
    ...
    public partial class EmployeeEntities : DbContext
    {
        ...
        public virtual ObjectResult<employeeDetail> FN_getEmployeeDetails()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<employeeDetail>("FN_getEmployeeDetails");
        }
    
        public virtual ObjectResult<employeeDetail> FN_getEmployeeDetails(MergeOption mergeOption)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<employeeDetail>("FN_getEmployeeDetails", mergeOption);
        }
        ...
        public virtual ObjectResult<Nullable<int>> FN_insertEmployee(string empName, Nullable<int> empSalary)
        {
            var empNameParameter = empName != null ?
                new ObjectParameter("EmpName", empName) :
                new ObjectParameter("EmpName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("FN_insertEmployee", empNameParameter, empSalaryParameter);
        }
    }
}
